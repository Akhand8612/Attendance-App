...
public class WeeklyOffActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        employeeCodeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                new IntentIntegrator(WeeklyOffActivity.this).initiateScan();
...
//                                             databaseConnection.deleteUserDesignation();
//                                             Toast.makeText(WeeklyOffActivity.this, "Select designation now", Toast.LENGTH_LONG).show();
...
//                                                 setUserDesignationSpinner();
//                                             } else {
//                                                 Toast.makeText(WeeklyOffActivity.this, "Weekly off not available on this unit", Toast.LENGTH_LONG).show();
...
//                    } else {
//                       // databaseConnection.deleteUserDesignation();
//                        AlertDialog.Builder builder = new AlertDialog.Builder(WeeklyOffActivity.this);
...
//
//                } else {
//                    Toast.makeText(WeeklyOffActivity.this, "Please scan employee code first to get designation", Toast.LENGTH_LONG).show();
//                }
//            }
//        });
...
//        });
        weeklyOffButtton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Empcode == "" && Compid == "") {
                    Toast.makeText(WeeklyOffActivity.this, "Please select employee code and enter unit code", Toast.LENGTH_LONG).show();


                } else if (unitCodeEditText.getText().toString() == "") {
                    Toast.makeText(WeeklyOffActivity.this, "Please enter unit code", Toast.LENGTH_LONG).show();

                }
//                else if (CompGroupID == "" && Desicode == "") {
//                    Toast.makeText(WeeklyOffActivity.this, "Please select designation", Toast.LENGTH_LONG).show();
//                }
                else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            ...
            CompGroupID = json.getString("CompGroupID");


            Toast.makeText(WeeklyOffActivity.this, "Please scan your unit now", Toast.LENGTH_SHORT).show();
            // new PostVersion(Employee_Details.this,Empcode).execute();
            if (Empcode.equals(getEmpcode)) {
//                    databaseConnection.deleteAttendanceDetail();
//                    databaseConnection.insertAttendanceDetail(CompGroupID, Compid, Unitcode, UnitLongitude, UnitLatitude, Empcode, Desicode, CreatedByUserID);
...
//    }
    ...
    private void getId() {
        waitingDialog = new SpotsDialog.Builder()
                .setContext(WeeklyOffActivity.this)
    ...
    public void postAttendanceIn() {
        ...
        if (isOnline == "0") {
            ...
            new PostAttendenceIn(WeeklyOffActivity.this).execute();
        } else {
...
//                }
    ...
    private void check() {
        LocationManager lm = (LocationManager) WeeklyOffActivity.this.getSystemService(Context.LOCATION_SERVICE);
        ...
        if (!gps_enabled && !network_enabled) {
            // notify user
            AlertDialog.Builder dialog = new AlertDialog.Builder(WeeklyOffActivity.this);
            ...
            dialog.setPositiveButton("Open Setting/सेटिंग खोलें", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface paramDialogInterface, int paramInt) {
                    ...
                    WeeklyOffActivity.this.startActivity(myIntent);
                    //get gps
                }
            });
    ...
    class PostAttendenceIn extends AsyncTask<Void, Void, Void> {
        ...
        //    nameValuePair.add(new BasicNameValuePair("Desicode", Desicode));
            nameValuePair.add(new BasicNameValuePair("DutyInLongitude", "0.0"));

            nameValuePair.add(new BasicNameValuePair("DutyInLatitude", "0.0"));
            nameValuePair.add(new BasicNameValuePair("DutyINDate", currentDateAndTime));
            nameValuePair.add(new BasicNameValuePair("AttType", "WO"));
